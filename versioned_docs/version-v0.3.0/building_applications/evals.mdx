---
title: Evaluations
description: Evaluate LLM applications with ogx's comprehensive evaluation framework
...
This guide walks you through the process of evaluating an LLM application built using ogx. For detailed API reference, check out the [Evaluation Reference](../references/evals_reference/) guide that covers the complete set of APIs and developer experience flow.
...
Now we'll evaluate the agent's responses using ogx's scoring API:
...
# Run evaluation using ogx's scoring API
...
ogx provides several built-in scoring functions:
