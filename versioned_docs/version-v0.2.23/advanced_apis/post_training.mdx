...
Post-training in ogx allows you to fine-tune models using various providers and frameworks. This section covers all available post-training providers and how to use them effectively.

## Overview

ogx provides multiple post-training providers:
...
[HuggingFace SFTTrainer](https://huggingface.co/docs/trl/en/sft_trainer) is an inline post training provider for ogx. It allows you to run supervised fine tuning on a variety of models using many datasets.
...
[TorchTune](https://github.com/pytorch/torchtune) is an inline post training provider for ogx. It provides a simple and efficient way to fine-tune language models using PyTorch.
