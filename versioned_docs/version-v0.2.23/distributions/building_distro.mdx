...
This guide will walk you through the steps to get started with building a ogx distribution from scratch with your choice of API providers.
...
options:
  ...
  --list-distros, --list-distributions
                        Show the available distributions for building a ogx distribution (default: False)
...
+------------------------------+-----------------------------------------------------------------------------+
| starter                      | Quick start template for running ogx with several popular providers |
+------------------------------+-----------------------------------------------------------------------------+
| sambanova                    | Use SambaNova for running LLM inference and safety                          |
+------------------------------+-----------------------------------------------------------------------------+
| remote-vllm                  | Use (an external) vLLM server for running LLM inference                     |
+------------------------------+-----------------------------------------------------------------------------+
| postgres-demo                | Quick start template for running ogx with several popular providers |
+------------------------------+-----------------------------------------------------------------------------+
...
+------------------------------+-----------------------------------------------------------------------------+
| dell                         | Dell's distribution of ogx. TGI inference via Dell's custom         |
|                              | container                                                                   |
+------------------------------+-----------------------------------------------------------------------------+
...
> Enter a name for your ogx (e.g. my-local-stack): my-stack
> Enter the image type you want your ogx to be built as (container or venv): venv

ogx is composed of several APIs working together. Let's select
...
> Enter provider for API telemetry: inline::meta-reference
 ...
 > (Optional) Enter a short description for your ogx:
...
ogx supports external providers that live outside of the main codebase. This allows you to create and maintain your own providers independently or use community-provided providers.
...
Now set some environment variables for the inference model ID and ogx Port and create a local directory to mount into the container's file system.
...
Now, let's start the ogx Distribution Server. You will need the YAML configuration file which was written out at the end by the `llama stack build` step.
...
Start the server for a ogx Distribution. You should have already built (or downloaded) and configured the distribution.
...
Using the list command, you can view all existing ogx distributions, including stacks built from templates, from scratch, or using custom configuration files.
