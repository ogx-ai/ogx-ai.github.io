---
title: ogx Architecture
description: Understanding ogx's service-oriented design and benefits
...
ogx allows you to build different layers of distributions for your AI workloads using various SDKs and API providers.

<img src="/img/llama-stack.png" alt="ogx" width="400" />
...
ogx addresses these challenges through a service-oriented, API-first approach:
...
**Robust Ecosystem**
- ogx is already integrated with distribution partners (cloud providers, hardware vendors, and AI-focused companies).
...
With ogx, you can focus on building your application while we handle the infrastructure complexity, essential capabilities, and provider integrations.
