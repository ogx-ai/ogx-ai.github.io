---
title: API Reference
description: Complete reference for ogx APIs
...
ogx provides a comprehensive set of APIs for building generative AI applications. All APIs follow OpenAI-compatible standards and can be used interchangeably across different providers.
...
All ogx APIs are designed to be OpenAI-compatible, allowing you to:
...
3. **Start the Server**: Launch the ogx server with your configuration
