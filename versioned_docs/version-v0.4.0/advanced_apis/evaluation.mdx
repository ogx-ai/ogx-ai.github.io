...
ogx provides multiple evaluation providers:
...
You can follow this [contributing guide](../references/evals_reference/index.mdx#open-benchmark-contributing-guide) to add more open-benchmarks to ogx
