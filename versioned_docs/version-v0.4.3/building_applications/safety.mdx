...
description: Implement safety measures and content moderation in ogx applications
...
Safety is a critical component of any AI application. ogx provides a comprehensive Shield system that can be applied at multiple touchpoints to ensure responsible AI behavior and content moderation.

## Shield System Overview

The Shield system in ogx provides:
