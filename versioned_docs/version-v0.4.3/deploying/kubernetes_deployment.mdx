...
For more information about the operator, see the [llama-stack-k8s-operator repository](https://github.com/ogx-ai/ogx-k8s-operator).
...
**Note:** For a complete list of supported distributions, see [distributions.json](https://github.com/ogx-ai/ogx-k8s-operator/blob/main/distributions.json) in the operator repository. To use a custom or non-supported distribution, set the `server.distribution.image` field with your container image instead of  `server.distribution.name`.
...
- **[LlamaStack Operator](https://github.com/ogx-ai/ogx-k8s-operator)** - Overview of llama-stack kubernetes operator
- **[LlamaStackDistribution](https://github.com/ogx-ai/ogx-k8s-operator/blob/main/docs/api-overview.md)** - API Spec of the llama-stack operator Custom Resource.
