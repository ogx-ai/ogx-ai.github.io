...
7. Configure ogx to use external APIs:
...
4. Check the ogx server logs for any error messages - turn on debug logging to get more information using `LLAMA_STACK_LOGGING=all=debug`.
