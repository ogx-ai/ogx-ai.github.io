---
title: APIs
description: Available REST APIs and planned capabilities in ogx
sidebar_label: APIs
sidebar_position: 1
---
...
A ogx API is described as a collection of REST endpoints following OpenAI API standards. We currently support the following APIs:
...
We are working on adding OpenAI API compatibility to ogx. This will allow you to use ogx with OpenAI API clients and tools.
