...
description: Comprehensive guides for building AI applications with ogx
...
ogx provides all the building blocks needed to create sophisticated AI applications.
...
### 🤖 **Agent Development**
- **[Agent Framework](./agent.mdx)** - Understand the components and design patterns of the ogx agent framework
