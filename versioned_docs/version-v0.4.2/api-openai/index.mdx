...
description: OpenAI-compatible APIs and features in ogx
...
ogx provides comprehensive OpenAI API compatibility, allowing you to use existing OpenAI API clients and tools with ogx providers. This compatibility layer ensures seamless migration and interoperability.

## Overview

OpenAI API compatibility in ogx includes:
...
Change your API endpoint from OpenAI to your ogx server:
...
client = openai.OpenAI(
    ...
    base_url="http://localhost:8000/v1"  # Your ogx server
)
```

### Step 2: Configure Providers
Set up your preferred providers in the ogx configuration:
...
Verify that your existing code works with ogx:
...
ogx supports OpenAI-style authentication:
...
ogx provides OpenAI-compatible error responses:
...
For the latest updates, follow our [GitHub releases](https://github.com/ogx-ai/llama-stack/releases) and [roadmap discussions](https://github.com/ogx-ai/llama-stack/discussions).
