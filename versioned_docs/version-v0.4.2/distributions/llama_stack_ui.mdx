...
If you don't have a ogx server running yet, see the [Starting ogx Server](../getting_started/starting_llama_stack_server.mdx) guide.
...
|----------|-------------|---------|
| `LLAMA_STACK_BACKEND_URL` | URL of your ogx server | `http://localhost:8321` |
