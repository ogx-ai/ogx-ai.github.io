...
The Files API provides file management capabilities for ogx. It allows you to upload, store, retrieve, and manage files that can be used across various endpoints in your application.
